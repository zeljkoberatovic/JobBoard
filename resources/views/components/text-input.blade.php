<div class="relative">
    {{-- Provjera je li tip elementa različit od "textarea" --}}
    @if ('textarea' != $type)
        {{-- Ako postoji referenca na formu, prikaži gumb za resetiranje i slanje forme --}}
        @if ($formRef)
        ...
        @endif
      {{-- Input polje s uvjetnim klasama --}}
